...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Pattern_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 23, 6)
    ...
    "Pattern\0slotChangePen\0\0newPen"
};
...
void Pattern::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Pattern *_t = static_cast<Pattern *>(_o);
        switch (_id) {
        case 0: _t->slotChangePen((*reinterpret_cast< QPen(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject Pattern::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_Pattern.data,
      qt_meta_data_Pattern,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Pattern.stringdata))
        return static_cast<void*>(const_cast< Pattern*>(this));
